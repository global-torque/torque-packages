...
This is the source and rights inventory for framework candidate `0.3.0`.
Counts cover regular asset files (`svg`, `webp`, raster images, and font
files) under the seven framework packages.

The 0.2.3 SFC reconciliation and 0.3.0 dependency migration change no framework
asset paths; the retained 0.2.2 inventory remains the asset baseline.
