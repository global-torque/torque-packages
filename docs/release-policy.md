...
The candidate's ordinary immutable release tag is `framework-v0.2.0` for the
`0.2.0` candidate. Dispatch the candidate workflow from that tag so its
attestations carry `refs/tags/framework-v0.2.0`. The provenance workflow
